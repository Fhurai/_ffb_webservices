...
require_once __DIR__ . '/../src/table/ScoresTable.php'; // Represents the Scores database table

// Initialize the ParameterEndpoint with the ScoresTable class
$endpoint = new ParameterEndpoint(ScoresTable::class);
