...
UNION 
SELECT s.id, f.id, 1 FROM series s, fanfictions f INNER JOIN authors a ON a.id=f.author_id WHERE s.name = "Story of the Sword DemonSeries" AND f.name = "Hero Quest: The Sword Demon Of Agnus" AND a.name = "The_Warrior_And_The_Scholar"
UNION
SELECT s.id, f.id, 2 FROM series s, fanfictions f INNER JOIN authors a ON a.id=f.author_id WHERE s.name = "Story of the Sword DemonSeries" AND f.name = "An Aegisborn in Aionios" AND a.name = "The_Warrior_And_The_Scholar"
UNION
SELECT s.id, f.id, 3 FROM series s, fanfictions f INNER JOIN authors a ON a.id=f.author_id WHERE s.name = "Story of the Sword DemonSeries" AND f.name = "The Power Of a Demon" AND a.name = "The_Warrior_And_The_Scholar";