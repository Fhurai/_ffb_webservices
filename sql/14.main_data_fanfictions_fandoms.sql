...
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "A Life Entwined" AND a.name = "" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Afterlife" AND a.name = "Vargras" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Xenoblade Chronicles 2: Afterstories" AND a.name = "Lord_Reinhardt" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Xenoblade Chronicles 2: Atonement" AND a.name = "Kiben007" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Shadows of Alrest" AND a.name = "Kiben007" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "A Place Called Home" AND a.name = "Darandus548" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Love in Low Orbit" AND a.name = "LotusRootsAndBambooShoots" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Temptation of Rex" AND a.name = "LotusRootsAndBambooShoots" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Fire Tempered" AND a.name = "LotusRootsAndBambooShoots" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "An Eternal History" AND a.name = "Seeker38" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "An Eternal History" AND a.name = "Seeker38" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Aegis Dish" AND a.name = "Steamedzing" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "A King Amongst Paupers" AND a.name = "Mitternachtwuten" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Lost in Orbit" AND a.name = "MementoVive" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Lost in Orbit" AND a.name = "MementoVive" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The One Where Nia (Eventually) Gets Something Nice" AND a.name = "Dragonbutts (Wayward_Dragon)" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Useful" AND a.name = "Vogelimkafig120" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Titan Eater" AND a.name = "Sobakiin" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "More Than Just a Memory" AND a.name = "Starsoarer" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Trinity: Awaken. Reconcile. Resurge." AND a.name = "Dragon_Falls" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Trinity: Awaken. Reconcile. Resurge." AND a.name = "Dragon_Falls" AND f.name = "Xenoblade Chronicles"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "A Visit" AND a.name = "Vogelimkafig120" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Soldier and the Thespian" AND a.name = "Defectzero" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "I Need a Healer" AND a.name = "TimeWillNowResume" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Nia telling her secret to Rex early" AND a.name = "Worswor" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "All Three Of Them" AND a.name = "InsideA14YearOldGirl" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "All Three Of Them" AND a.name = "InsideA14YearOldGirl" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "New Frontier" AND a.name = "Kingcrustnip" AND f.name = "Smash Brothers Ultimate"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "New Frontier" AND a.name = "Kingcrustnip" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The New World" AND a.name = "Kingcrustnip" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Heros Return" AND a.name = "Kingcrustnip" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Settling In" AND a.name = "Kingcrustnip" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Beach!" AND a.name = "Kingcrustnip" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Moving In" AND a.name = "Kingcrustnip" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Let's Go for a Ride" AND a.name = "Kingcrustnip" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "I Will Always Be By Your Side" AND a.name = "Kingcrustnip" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Popcorn!" AND a.name = "Kingcrustnip" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Family" AND a.name = "Kingcrustnip" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Where we came from" AND a.name = "BlazingSoul500" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The House That Rex Built" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The House That Rex Built" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "They Talked Later" AND a.name = "Bcd_Xc" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Wake to See Your True Emancipation" AND a.name = "NidoranDuran" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "All of the Above" AND a.name = "Nopeisok" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Her War" AND a.name = "PackerDragon" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "You're The Greatest Gift I Could Ask For" AND a.name = "BlazingSoul500" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Lovemaking with a Leftherian" AND a.name = "BEWD4133" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Lovemaking with a Leftherian" AND a.name = "BEWD4133" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Nia's Sundress Is Too Distracting!" AND a.name = "Mister_Phoenix" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Early Morning Ramble" AND a.name = "UltraPop" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Mistress and Pet" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Mistress and Pet" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Where We Belong" AND a.name = "GayFlyFish" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Where We Belong" AND a.name = "GayFlyFish" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Teaching Them a Thing or Three" AND a.name = "SmutWizard" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Teaching Them a Thing or Three" AND a.name = "SmutWizard" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Masterpiece" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Masterpiece" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Caught my sleepy star" AND a.name = "Tbat" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Shard of the Aegis (Future Reborn)" AND a.name = "ImAgInAtE_404" AND f.name = "Harry Potter - J. K. Rowling"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Shard of the Aegis (Future Reborn)" AND a.name = "ImAgInAtE_404" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Revising the Script" AND a.name = "MachineryField" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Cloudclear Candy" AND a.name = "AbyssalAriel" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Cloudclear Candy" AND a.name = "AbyssalAriel" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Father Figure" AND a.name = "Optional_adventure" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Hidden Shield" AND a.name = "Sapphiria" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Returning the Favor" AND a.name = "SteamedZing" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Off-Seers Need a Good Laugh Too" AND a.name = "Rainbowwing251" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Melt" AND a.name = "Ilvidis" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Forever After" AND a.name = "Egildidnothingwrong (Lavider)" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Dreams" AND a.name = "" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Do I Remember You?" AND a.name = "OathkeeperAlexis" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Do I Remember You?" AND a.name = "OathkeeperAlexis" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Do I Remember You?" AND a.name = "OathkeeperAlexis" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "A step away" AND a.name = "XSparklingRavenx" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "His Mio" AND a.name = "Ilvidis" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Write it down or you'll forget" AND a.name = "Starcrossedsky" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Knowledge obtained" AND a.name = "Lyre (Lyrecho)" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Sunk Cost Fallacy" AND a.name = "ThatWindingPath" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "There is a handful of courage in my heart" AND a.name = "Lyre (Lyrecho)" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Deathly loneliness attacks" AND a.name = "Lyre (Lyrecho)" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Risk negation" AND a.name = "Lyrecho" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Quick to their ends our candles burn until we're free" AND a.name = "Lyre (Lyrecho)" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Two souls once lost" AND a.name = "Lyre (Lyrecho)" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Eleven, eleven" AND a.name = "Lyre (Lyrecho)" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Who, me?" AND a.name = "Captwaddledoo" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "'Til We Find Ourselves, Again" AND a.name = "Dsw78" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Reunited" AND a.name = "RinOfTheStars" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Reunited" AND a.name = "RinOfTheStars" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "A Bonding of Two" AND a.name = "EuphoricMother" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Know thy enemy" AND a.name = "Sylvalum" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Sundancer" AND a.name = "WisteriaJD (JD2357)" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "A lot can happen between now and never" AND a.name = "Swordlegion" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "How they used to Love" AND a.name = "ArchivalBerethNocta" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Just a Night In Camp" AND a.name = "EuphoricMother" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Where We Don't Belong" AND a.name = "DewitLater" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Where We Don't Belong" AND a.name = "DewitLater" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Where We Don't Belong" AND a.name = "DewitLater" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Our Hopes and Dreams" AND a.name = "Heronsong" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "For Want of a Dry Wing" AND a.name = "AliceYouWereHere" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "For Want of a Dry Wing" AND a.name = "AliceYouWereHere" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Clock Strikes Six" AND a.name = "ThatWindingPath" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "A Quiet, Empty Moment" AND a.name = "Cold_Jolteon" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Queen's Orders" AND a.name = "Dragon_Falls" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Queen's Orders" AND a.name = "Dragon_Falls" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "From the Cradle to the Grave (and back again)" AND a.name = "Rosifly" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Her Mimi" AND a.name = "Melodramatic_Pretzel" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "And eat it too" AND a.name = "Starcrossedsky" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "What Comes Next" AND a.name = "Leonidskies" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "You Got Any Babies?" AND a.name = "RavioxHilda" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Our Feelings Will Never Change" AND a.name = "Aegishammer13" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Reimagination" AND a.name = "Dsw78" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Whatever It Is, With You" AND a.name = "Ratly" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Long or Short" AND a.name = "Meme_Engine" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "I am the only lonely casualty" AND a.name = "Starcrossedsky" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "A Promise of Morning Dew" AND a.name = "MementoVive" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "A Place To Be Alive" AND a.name = "SilberFelx" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "A Strange Feeling" AND a.name = "Ratly" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "It Was Right On The Tip Of My Tongue" AND a.name = "SuperNerd92" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Not Mine" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Momentary Weakness" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Resemblances" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "None, Then Three" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "None, Then Three" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Talk" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Talk" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Fledglings" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Fledglings" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Endless Strength" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Endless Strength" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "For my part this is all I need" AND a.name = "Lioninjawarloc" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "This goodbye is not the end" AND a.name = "Justicetom" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "This goodbye is not the end" AND a.name = "Justicetom" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "This goodbye is not the end" AND a.name = "Justicetom" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Catching up for our past lives" AND a.name = "Tsukarine" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Sleepy Time with Noah and Mio" AND a.name = "FiliaSnowe" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Instruments of Rebirth" AND a.name = "Lumailia" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "You're Here; That's More Than Enough" AND a.name = "Ansvel_Ashe" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Duet" AND a.name = "Essaysforbreakfast" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Forever Interlinked Futures" AND a.name = "ValorFennekin34" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Sotto Voce" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Hand in Hand" AND a.name = "StrayedPath" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Hand in Hand" AND a.name = "StrayedPath" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Consequences of Indirect Kissing" AND a.name = "KwIl" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "May Our Voices Reach, In Time" AND a.name = "Ansvel_Ashe" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Driver and (Artificial) Blade" AND a.name = "Worswor" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Promises are meant to be kept" AND a.name = "Frozenbear09" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Promises are meant to be kept" AND a.name = "Frozenbear09" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Promises are meant to be kept" AND a.name = "Frozenbear09" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Noah and the Name Game" AND a.name = "BagofChips" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Ad Tertium / Upon the Third" AND a.name = "DredgenSoul" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Ad Tertium / Upon the Third" AND a.name = "DredgenSoul" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Ad Tertium / Upon the Third" AND a.name = "DredgenSoul" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Traitor in the Mirror" AND a.name = "Pachipower" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Miyabi In The Middle" AND a.name = "LunarMelodia" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Breaking the Miyabunnit" AND a.name = "LunarMelodia" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Mio's Guide to Child Birth" AND a.name = "Alucard45" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "No Nut Noah-vember" AND a.name = "AbyssalAriel" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "A Bridge Between Worlds" AND a.name = "WriterRenEllis" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "A Bridge Between Worlds" AND a.name = "WriterRenEllis" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "A Bridge Between Worlds" AND a.name = "WriterRenEllis" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Fast Travel to Flavour City" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Healers' Fate" AND a.name = "SomeDatsunGuy" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Potato Eyes of Spudding Justice" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Potato Eyes of Spudding Justice" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Too Much Information" AND a.name = "AbyssalAriel" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The simple rites of undead war-girls" AND a.name = "Lumailia" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "New Moon [Hiatus]" AND a.name = "LunarMelodia" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The City and Alexandria" AND a.name = "Raelhorn" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Letters To Our Son" AND a.name = "LunarMelodia" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "In Another Life" AND a.name = "WriterRenEllis" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "In Another Life" AND a.name = "WriterRenEllis" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Reunion" AND a.name = "Pocketcucco" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Reunion" AND a.name = "Pocketcucco" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Reunion" AND a.name = "Pocketcucco" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Tea Leaves and Fourtune Clovers" AND a.name = "WriterRenEllis" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Tea Leaves and Fourtune Clovers" AND a.name = "WriterRenEllis" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Tea Leaves and Fourtune Clovers" AND a.name = "WriterRenEllis" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "A chat between the Monado's Heir and Master Driver" AND a.name = "Nopeisok" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "A chat between the Monado's Heir and Master Driver" AND a.name = "Nopeisok" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "A chat between the Monado's Heir and Master Driver" AND a.name = "Nopeisok" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Her Majesty's Masquerade" AND a.name = "Raelhorn" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Her Majesty's Masquerade" AND a.name = "Raelhorn" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Her Majesty's Masquerade" AND a.name = "Raelhorn" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Walking Forward, Looking Back" AND a.name = "AceStarChaser" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Walking Forward, Looking Back" AND a.name = "AceStarChaser" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "A Mother's Love and a Queen's Regret" AND a.name = "BEWD4133" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "A Mother's Love and a Queen's Regret" AND a.name = "BEWD4133" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Mirror Mirror" AND a.name = "ThatWindingPath" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "For When The Dawn Comes Again" AND a.name = "DredgenSoul" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "For When The Dawn Comes Again" AND a.name = "DredgenSoul" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "For When The Dawn Comes Again" AND a.name = "DredgenSoul" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Queen in the Memorial Hall" AND a.name = "Raelhorn" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Queen in the Memorial Hall" AND a.name = "Raelhorn" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Show and Tell" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Show and Tell" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Life goes on" AND a.name = "Gayzed" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Father, The Son, and the Rubber Duck" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Father, The Son, and the Rubber Duck" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Father, The Son, and the Rubber Duck" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Riki Is Bestest Grampypon!" AND a.name = "BagofChips" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Riki Is Bestest Grampypon!" AND a.name = "BagofChips" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Remember We Were Partners in Crime" AND a.name = "Cythieus" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Remember We Were Partners in Crime" AND a.name = "Cythieus" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Remember We Were Partners in Crime" AND a.name = "Cythieus" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Unforeseen Reunion" AND a.name = "Whip9063" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Unforeseen Reunion" AND a.name = "Whip9063" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Unforeseen Reunion" AND a.name = "Whip9063" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Broken Gauntlet (SPOILERS FOR XC3FR)" AND a.name = "Mememan64" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Broken Gauntlet (SPOILERS FOR XC3FR)" AND a.name = "Mememan64" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Aionios' Strongest!" AND a.name = "Trumai" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "New Life" AND a.name = "Onaliiim" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "New Feelings" AND a.name = "Nopeisok" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "His Best Work's Done in the Bath" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "His Best Work's Done in the Bath" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Ciao Papa" AND a.name = "BagofChips" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Ciao Papa" AND a.name = "BagofChips" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Ciao Papa" AND a.name = "BagofChips" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Melancholy Milton and Mythra" AND a.name = "Nopeisok" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Melancholy Milton and Mythra" AND a.name = "Nopeisok" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Memories of a distant, near world" AND a.name = "Nth111" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Looking up from Beneath the Ripples" AND a.name = "Ferry5067" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Looking up from Beneath the Ripples" AND a.name = "Ferry5067" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Across time and space" AND a.name = "Jellijeans" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Across time and space" AND a.name = "Jellijeans" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Birdsong" AND a.name = "Sylvalum" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Full of Beans" AND a.name = "Raelhorn" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Full of Beans" AND a.name = "Raelhorn" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Full of Beans" AND a.name = "Raelhorn" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Memories of the Stoutheart and the Queen" AND a.name = "ZAD_GX" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Memories of the Stoutheart and the Queen" AND a.name = "ZAD_GX" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Memories of the Stoutheart and the Queen" AND a.name = "ZAD_GX" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "And Those We've Left Behind" AND a.name = "Perciatelli" AND f.name = "Xenoblade Chronicles"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "And Those We've Left Behind" AND a.name = "Perciatelli" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Campfire Conversations" AND a.name = "Discar" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Campfire Conversations" AND a.name = "Discar" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Campfire Conversations" AND a.name = "Discar" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Many Parts of One Identity" AND a.name = "Blumbrr" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Many Parts of One Identity" AND a.name = "Blumbrr" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "We’ll meet again" AND a.name = "Za_Waruldo_is_MINE" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "We’ll meet again" AND a.name = "Za_Waruldo_is_MINE" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "We’ll meet again" AND a.name = "Za_Waruldo_is_MINE" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Pangram" AND a.name = "SirTeateiMoonlight" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Pangram" AND a.name = "SirTeateiMoonlight" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Scavenger's Code, Number Eight" AND a.name = "Looking4Amuro" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Scavenger's Code, Number Eight" AND a.name = "Looking4Amuro" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Scavenger's Code, Number Eight" AND a.name = "Looking4Amuro" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Ye Shall Be As Gods" AND a.name = "AceAxolotl" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "A Caring Hand" AND a.name = "Exhausted_Sloth" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Scars We Carry" AND a.name = "Minmei" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Moments Before Midnight" AND a.name = "Nopeisok" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Moments Before Midnight" AND a.name = "Nopeisok" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Moments Before Midnight" AND a.name = "Nopeisok" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The rhapsodist" AND a.name = "Archangelgf" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Origin Archive" AND a.name = "Lumailia" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Origin Archive" AND a.name = "Lumailia" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Origin Archive" AND a.name = "Lumailia" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Love Me Like That" AND a.name = "OathkeeperAlexis" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "1+1=1" AND a.name = "Secret_Artistry" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "1+1=1" AND a.name = "Secret_Artistry" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "1+1=1" AND a.name = "Secret_Artistry" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Red Left Hand of Fate" AND a.name = "Raelhorn" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Red Left Hand of Fate" AND a.name = "Raelhorn" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Red Left Hand of Fate" AND a.name = "Raelhorn" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Aionios High 101" AND a.name = "AioniosHigh" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Forever Interlinked: Futures Redeemed" AND a.name = "ValorFennekin34" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Forever Interlinked: Futures Redeemed" AND a.name = "ValorFennekin34" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Forever Interlinked: Futures Redeemed" AND a.name = "ValorFennekin34" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Hot and cold" AND a.name = "Sylvalum" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Hero Quest: The Sword Demon Of Agnus" AND a.name = "The_Warrior_And_The_Scholar" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Hero Quest: The Sword Demon Of Agnus" AND a.name = "The_Warrior_And_The_Scholar" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "An Aegisborn in Aionios" AND a.name = "The_Warrior_And_The_Scholar" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "An Aegisborn in Aionios" AND a.name = "The_Warrior_And_The_Scholar" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "An Aegisborn in Aionios" AND a.name = "The_Warrior_And_The_Scholar" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Power Of a Demon" AND a.name = "The_Warrior_And_The_Scholar" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Stronger Together" AND a.name = "Nopeisok" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Stronger Together" AND a.name = "Nopeisok" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Stronger Together" AND a.name = "Nopeisok" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Stasis" AND a.name = "AceAxolotl" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Stasis" AND a.name = "AceAxolotl" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Stasis" AND a.name = "AceAxolotl" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Drifting soul" AND a.name = "Orpheus_under_starlight" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Drifting soul" AND a.name = "Orpheus_under_starlight" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Drifting soul" AND a.name = "Orpheus_under_starlight" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Beginning's End" AND a.name = "BtrSwt" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Beginning's End" AND a.name = "BtrSwt" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Beginning's End" AND a.name = "BtrSwt" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "As Nature Intended?" AND a.name = "KittykatOwO" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The N stands for ""Not having a good time""" AND a.name = "Secret_Artistry" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The N stands for ""Not having a good time""" AND a.name = "Secret_Artistry" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The N stands for ""Not having a good time""" AND a.name = "Secret_Artistry" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Our Repentance" AND a.name = "ValorFennekin34" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "All my dreams come true" AND a.name = "Tbat" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Second Chances" AND a.name = "Little_Anxiety_Plant" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Second Chances" AND a.name = "Little_Anxiety_Plant" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Second Chances" AND a.name = "Little_Anxiety_Plant" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Tales of Interlinked Worlds" AND a.name = "ArcaneMadman" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Tales of Interlinked Worlds" AND a.name = "ArcaneMadman" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Tales of Interlinked Worlds" AND a.name = "ArcaneMadman" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Visions of Another" AND a.name = "Secret_Artistry" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Goldenrod" AND a.name = "Eryth_sea" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Future Awaits" AND a.name = "Halteclare" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Future Awaits" AND a.name = "Halteclare" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Future Awaits" AND a.name = "Halteclare" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Storms" AND a.name = "MementoVive" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Storms" AND a.name = "MementoVive" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Storms" AND a.name = "MementoVive" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "End's Journey" AND a.name = "MissMiccy" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "End's Journey" AND a.name = "MissMiccy" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "End's Journey" AND a.name = "MissMiccy" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "First Chance" AND a.name = "Blumbrr" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "First Chance" AND a.name = "Blumbrr" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Gift of Unity" AND a.name = "DewitLater" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Gift of Unity" AND a.name = "DewitLater" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "The Gift of Unity" AND a.name = "DewitLater" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Triad" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Romance Stories for the Half-Homs Girl" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Romance Stories for the Half-Homs Girl" AND a.name = "Rozteka" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Loving you is a losing game" AND a.name = "BelgianPallasCat" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Memory Husks" AND a.name = "Aionian_Lucario" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Memory Husks" AND a.name = "Aionian_Lucario" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Memory Husks" AND a.name = "Aionian_Lucario" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "A Parent's Secret" AND a.name = "Nopeisok" AND f.name = "Xenoblade Chronicles 1"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "A Parent's Secret" AND a.name = "Nopeisok" AND f.name = "Xenoblade Chronicles 2"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "A Parent's Secret" AND a.name = "Nopeisok" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "(Re)unions" AND a.name = "Nopeisok" AND f.name = "Xenoblade Chronicles 3"
UNION
SELECT ff.id, f.id FROM `fandoms` f, `fanfictions` ff INNER JOIN `authors` a ON a.id = ff.author_id WHERE ff.name = "Xenoblade Chronicles 3: Hero Quest Counterbalance" AND a.name = "YootisPoshil" AND f.name = "Xenoblade Chronicles 3"
UNION
