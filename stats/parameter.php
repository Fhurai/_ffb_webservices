...
try {
    ...
    switch ($method) {
        ...
        case 'GET':
            // Handle GET requests and pass 'parameter' and the specific parameter ID as arguments
            // The parameter ID is retrieved from the 'parameter' parameter in the GET request
            $endpoint->get($_REQUEST, 'parameter', $_GET['parameter']);
            break;
